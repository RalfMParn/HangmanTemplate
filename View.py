...
class View(Tk):
    ...
    def create_buttons(self):
        ...
        send = Button(self.__frame_top, text='Saada', font=self.__default, state=DISABLED, command=self.__controller.btn_send_click)
        Button(self.__frame_top, text='Edetabel', font=self.__default, command=self.__controller.btn_scoreboard_click).grid(row=0, column=1, padx=5, pady=2, sticky=EW)
